...
public class TestData {
    ...
    public static final String TEST_USERNAME = "duo04291";
    ...
    public static final String TEST_COMMAND_STORAGE_URL = "https://osgs-firestore-to-rest.herokuapp.com/{tenantName}/{sessionIdentifier}/commands";
