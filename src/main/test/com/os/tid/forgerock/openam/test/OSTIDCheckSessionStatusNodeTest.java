...
@Test
public class OSTIDCheckSessionStatusNodeTest extends OSTIDLoginNodeTest{
    @BeforeMethod
    ...
    public void testCheckSessionProcessMissingData() throws NodeProcessException{
        // Given
        OSTIDCheckSessionStatusNode node = new OSTIDCheckSessionStatusNode(realm, annotatedServiceRegistry);
